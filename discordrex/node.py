...
class Node(object):
    ...
    :param dict dictionary: dictionary to convert into object
    """
    ...
    def __getattr__(self, name: str) -> Any:
        if name in self.do: return self.do[name](self)
        if name not in self.__dict__: return None
...
class File(Node):
    ...
    :param str filePath: the file's path
    :param str encoding: the file's encoding
    """
